...
class OnlineListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        global buffer, bufSize, idx, clf, prevchar
        ...
        for hand in frame.hands:
            ...
            buffer.append([float(i) for i in input[2:]])
            idx += 1
            if idx >= bufSize:
                a = np.array(buffer)
                ...
                buffer = []
                idx = 0
            with open('data/roll/test_n.csv', mode = 'ab') as csv_file:
