...
void parseChar(char c) { 
  switch(c) { 
    ...
    case 'j' : 
      break;
    case 'k' :
      bend(4);bend(3);rotateLeft(2);rotateRight(1);swingThumb(1); 
      break;
    case 'l' :
      break;
    case 'm' : 
    ...
    case 'n' :
      break;
    case 'o' :
      bend(1);bend(2); bend(3); bend(4); bend(5); swingThumb(1);
      break;
    case 'p' :
      bendWrist();bend(4);bend(3);rotateLeft(2);rotateRight(1);swingThumb(1);
      break;
    case 'q' : 
      bendWrist();bend(4);bend(3);bend(2);swingThumb(1);
      break;
    case 'r' :
      bend(4);bend(3); swingThumb(3);rotateLeft(1);rotateRight(2);curl(2);
      break;
    case 's' : 
      bend(4);bend(3);bend(2);bend(1);swingThumb(1);curl(5)
      break;
    case 't' :
      bend(4);bend(3);bend(2);swingThumb(1);curl(5);bend(1);
      break;
    case 'u' :
      bend(4);bend(3);swingThumb(3);curl(5);
      break;
    case 'v' :
      bend(4);bend(3);swingThumb(3);curl(5);rotateLeft(2);rotateRight(1);
      break;
    case 'w' :
      bend(4);rotateRight(1);rotateRight(2);swingThumb(3);curl(5)
      break;
    case 'x' :
      bend(4);bend(3);bend(2);curl(1);swingThumb(1);bend(5)
      break;    
    case 'y' :
      bend(3);bend(2);bend(1);
      break; 
    case 'z' : //want to loop it
      bend(4);bend(3);bend(2);rotateLeft(1);bendWrist();
      normalizePosition();
      break;       
    case ' ' : 
      delay(500); 
